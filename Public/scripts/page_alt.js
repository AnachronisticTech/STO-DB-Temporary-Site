...
visualGuide.visualGroups = {
    ...
    start:{
        ...
        children:[
            {type:'htmlTag', tag:'div', flexC:'h', style:'padding-right:10px;', children:[
                {type:'htmlTag', tag:'h1', color:'text-voy-yellow-1', text:'Star Trek : The New Age'},
                ...
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Star Trek: The New Age (TNA) is an ongoing short fiction series set in the Star Trek Online universe. The series follows the adventures of the Sovereign class Starfleet vessel U.S.S. Pearce in the early years of the 25th century. Though the series takes place in an era of war for Starfleet and the United Federation of Planets, much of the story focuses on the personal histories of the crew and their efforts to overcome their own demons.'},
                {type:'row', flex:'h', flexC:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'}
                ]},
                {type:'htmlTag', tag:'h3', color:'text-voy-yellow-1', text:'Series summary'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Starfleet Intelligence Agent Jessica Mayn is assigned to the U.S.S. Pearce in the year 2409 in an undercover operation to identify and apprehend an unknown party responsible for a data leak that resulted in significant casualties to a Starfleet vessel weeks earlier. Attempting to evade Mayn, the individual resposnsible causes an expolsion that results in casualties aboard the Pearce, including the death of the executive officer. Shortly after, captain Talia Rem and several of the bridge crew are kidnapped by a criminal organisation, and Mayn - having identified the traitor - apprehends him and takes command of the Pearce to launch a rescue mission. The organisation is left in disarray when Mayn leads an assault on their compund, rescuing the captured crew, and Mayn joins the Pearce as first officer, resigning from Starfleet Intelligence.'},
                {type:'row', flex:'h', flexC:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'}
                ]},
                {type:'htmlTag', tag:'h3', color:'text-voy-yellow-1', text:'Main cast'},
                {type:'htmlTag', tag:'ul', children:[
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Captain Talia Rem'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Commander Jessica Mayn'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Lieutenant Commander S\'Tash'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Lieutenant Commander Muriel Khoury'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Lieutenant Anton Cole'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Lieutenant Kavar'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Lieutenant T\'Vrell'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Lieutenant Neal Morton'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Ensign Paleth Sh\'Tirreq'},
                    {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Ensign Kiaro Moretti'}
                ]},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:''},
                {type:'row', flex:'h', flexC:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'}
                ]},
                {type:'htmlTag', tag:'div', style:'margin-left:20px; float:right;', children:[
                    {type:'bracket', template:LCARS.templates.sdk.bracket.typeA, children:[
                        {type:'img', src:'images/book_1_cover.jpg', style:'margin-left:25px; margin-right:25px;'}
                    ]},
                    {type:'htmlTag', tag:'h3', color:'text-voy-yellow-1', style:'text-align:center;', text:'Book One - Our Last Battle'}
                ]},
                {type:'htmlTag', tag:'h3', color:'text-voy-yellow-1', text:'Episode summary - 1x01 Our Last Battle'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Starfleet Intelligence Agent Jessica Mayn is assigned to the U.S.S. Pearce in the year 2409 in an undercover operation to identify and apprehend an unknown party responsible for a data leak that resulted in significant casualties to a Starfleet vessel weeks earlier. While posing as an ensign performing security upgrades to the ship\'s main computer, the fugitive attempts to cover his tracks and stop Mayn by detonating a phaser next to a power relay, injuring Mayn, killing the first officer, and wounding three others.'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'With the Pearce on high alert, and all of her leads destroyed in the explosion, Mayn decides - against the advice of her superiors - to enlist the aid of the vessel\'s commanding officer, Captain Talia Rem. Despite a rocky start to the collaboration, the two officers begin reconstructing some of the lost data, however the ship receives a distress call from a nearby system and rushes to offer assistance.'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Immediately after entering the system, the ship is ambushed by light raiders. Before the shields can be raised a strike team transports into the command centre, captures Rem and several of the bridge crew before returning to the raiders and retreating to a planet in the system.'},
                {type:'row', flex:'h', flexC:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'}
                ]},
            ]}
    ...
    intro:{
        ...
        children:[
            {type:'htmlTag', tag:'div', flexC:'h', style:'padding-right:10px;', children:[
                {type:'htmlTag', tag:'h3', text:'The New Age - Season one intro', color:'text-voy-yellow-1'},
                {type:'bracket', template:LCARS.templates.sdk.bracket.typeA, children:[
                    {type:'row', flex:'h', flexC:'h', style:'margin-left:25px; margin-right:25px;', children:[
                        {type:'htmlTag', tag:'video', attrs:[{attr:'width', value:'100%'}, {attr:'height', value:'auto'}, {attr:'controls', value:''}], children:[
                        {type:'htmlTag', tag:'source', attrs:[{attr:'src', value:'images/intro.mp4'}, {attr:'type', value:'video/mp4'}]}
                        ]}
                    ]}
                ]}
            ]}
    ...
    captain:{
        ...
        children:[
            {type:'htmlTag', tag:'div', flexC:'h', style:'padding-right:10px;', children:[
                {type:'htmlTag', tag:'div', style:'margin-left:20px; float:right;', children:[
                    {type:'bracket', template:LCARS.templates.sdk.bracket.typeA, children:[
                        {type:'img', src:'images/talia_1.jpg', style:'margin-left:25px; margin-right:25px;'}
                    ]},
                    {type:'htmlTag', tag:'h3', color:'text-voy-yellow-1', text:'Talia Rem - ca. 2409'},
                    {type:'htmlTag', tag:'ul', children:[
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Rank: Captain'},
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Species: Human/Borg'},
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Gender: Female'},
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Age: 26'}
                    ]}
                ]},
                {type:'htmlTag', tag:'h2', color:'text-voy-yellow-1', text:'Rem, Natalie'},
                {type:'htmlTag', tag:'h3', color:'text-voy-grey-1', style:'margin-bottom:0px;', text:'Commanding officer'},
                {type:'htmlTag', tag:'h3', color:'text-voy-grey-1', text:'U.S.S. Pearce - NCC-93083'},
                {type:'row', flex:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'},
                ]},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Captain Talia Rem was the commanding officer of the U.S.S. Pearce in the early to mid 25th century. She was known for her efforts in repelling the Mirror Universe invasion during the Battle of Vauthil Station as well as her temporary position as captain of the U.S.S. Dauntless during its first long-range quantum slipstream test flight.'},
                {type:'row', flex:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'},
                ]},
                {type:'htmlTag', tag:'h3', text:'Early life', color:'text-voy-yellow-1'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Natalie Rem, daughter of Andrew and Carla Rem, was born on Reuben Prime in 2384. Natalie\'s father was a struggling merchant and, as his buisness continued to fail around him, Carla took three-year-old Natalie back to her home in the Quadra Sigma system. The colony was attacked by the Borg the following year, and Natalie along with her mother and all the other colonists were assimilated.'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Natalie spent thirteen years in a Borg maturation chamber until the vessel she was being stored on was destroyed by an ion storm. Several days later, the wreckage of the vessel was detected and scavanged by a mining vessel which was returning to Federation space. The chamber, along with a section of computer memory, was recovered with Natalie still alive inside. While the crew of the vessel were convinced the Borg technology should be destroyed before the Collective returned to retreive it, captain Grigory Kovac changed his mind when the contnets of the memory fragment were recovered and he learned that the occupant of the chamber had been assimilated at a very young age.'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Kovac convinced his crew to risk opening the chamber and attempt to save the girl. However, when the pod was opened and the occupant removed, the young drone could not function without orders from the Hive and quickly collapsed in shock. The medic aboard the minning ship managed to stabilise her, but came to the conclusion that reviving the girl again could lead to her death. En route back to the Federation, the medic studied what he could of the logs of the U.S.S. Voyager, a Starfleet vessel that had been lost in the Delta Quadrant and had returned seven years later with its own Borg crew member. He noted that the former drone\'s human appearance had been mostly restored, but that she had been a drone for a considerale length of time prior to rescue.'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'After consulting Kovac, the medic attempted a radical procedure of his own design where he isolated the damaged Borg instructions in the girl\'s cranial implants and attempted to erase them. He then attempted to remove some of the implants along the face and upper torso, but his lack of expertise in surgery resulted in scarring in several places. Regardless, the procedure was deemed a success and the girl was removed from sedation. Kovac attempted to interact with her, but it became quickly clear that she had no memory of either her time with the Borg or prior to assimilation.'},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Over the next few weeks Kovac and his wife took it upon themselves to help the young woman - later identified as Natalie Rem, though she preferred the nickname Talia - become a functioning member of the crew who could interact in social situations. They also hid from her the fact of her assimilation as well as any data they had on the Borg. Talia made quick progress learning the social graces, though she realised that most of the crew seemed uneasy when she was around. Notably, she was the only one with cybernetic implants, and though she saw many different species with many different physical features, she was the only one with grey skin and eyes.'},
                {type:'row', flex:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'},
                ]},
            ]},
    ...
    crewMember:{
        ...
        children:[
            {type:'htmlTag', tag:'div', flexC:'h', style:'padding-right:10px;', children:[
                {type:'htmlTag', tag:'div', flexC:'h', style:'margin-left:20px; float:right;', children:[
                    {type:'bracket', template:LCARS.templates.sdk.bracket.typeA, children:[
                        {type:'img', src:'images/pearce_1.jpg', style:'margin-left:25px; margin-right:25px;'}
                    ]},
                    {type:'htmlTag', tag:'h3', color:'text-voy-yellow-1', text:'caption'},
                    {type:'htmlTag', tag:'ul', children:[
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-1', text:'Rank: '},
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Species: '},
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Gender: '},
                        {type:'htmlTag', tag:'li', color:'text-voy-grey-2', text:'Age: '}
                    ]}
                ]},
                {type:'htmlTag', tag:'h2', color:'text-voy-yellow-1', text:'Last-name, First-name Middle-name'},
                {type:'htmlTag', tag:'h3', color:'text-voy-grey-1', style:'margin-bottom:0px;', text:'Position'},
                {type:'htmlTag', tag:'h3', color:'text-voy-grey-1', text:'U.S.S. Pearce - NCC-93083'},
                {type:'row', flex:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'},
                ]},
                {type:'htmlTag', tag:'p', color:'text-voy-grey-1', text:'Biography'},
                {type:'row', flex:'h', style:'min-height:0px; margin-bottom:8px;', children:[
                    {type:'bar', version:'tiny', color:'bg-blue-4', noEvent:true, flexC:'h'},
                ]},
            ]}
