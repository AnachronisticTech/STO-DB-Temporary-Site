...
// children:[
//     //Header
//     {type:'row', version:'header', flex:'h', children:[{type:'cap', version:'left', color:'bg-voy-grey-1'}, {type:'title', text:'U.S.S. Pearce - Database'}, {type:'bar', flexC:'h', color:'bg-voy-grey-1'}, {type:'cap', version:'right', color:'bg-voy-grey-1'}]},
    
//     //Scroll Content Area
//     {type:'content', style:'margin-left:60px; margin-right:60px; width:calc(100% - 120px); min-width:0px; padding-left:5px; padding-right:5px;', flexC:'v', id:'viewport-content'},
    
//     //Footer
//     // {type:'bar', version:'tiny', color:'bg-voy-grey-1', noEvent:true, flexC:'h'},

//     //Section Control Buttons
//     {type:'htmlTag',tag:'div', id:'ui-controls', style:'width:calc(100% - 130px);', children:[

//         //Crew UI
//         {type:'row', flex:'h', id:'crew-row-1', style:'margin-bottom:5px; margin-left:65px; margin-right:65px; min-width:0px; width:calc(100% - 130px);', children:[
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Talia Rem', click:function(){visualGuide.events.generateVisualGroups('talia')}},
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1',  label:'Jessica Mayn', click:function(){visualGuide.events.generateVisualGroups('jessica')}},
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Anton Cole', click:function(){visualGuide.events.generateVisualGroups('crewMember');}},
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Muriel Khoury', click:function(){visualGuide.events.generateVisualGroups('crewMember')}},
//             {type:'button', style:'margin-left:0px;', flexC:'h', color:'bg-voy-yellow-1', label:'Neal Morton', click:function(){visualGuide.events.generateVisualGroups('crewMember')}},
//         ]},
//         {type:'row', flex:'h', id:'crew-row-2', style:'margin-bottom:5px; margin-left:65px; margin-right:65px; min-width:0px; width:calc(100% - 130px);', children:[
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Paleth sh\'Tirreq', click:function(){visualGuide.events.generateVisualGroups('crewMember')}},
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1',  label:'Kiaro Moretti', click:function(){visualGuide.events.generateVisualGroups('crewMember')}},
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'T\'Vrell', click:function(){visualGuide.events.generateVisualGroups('crewMember');}},
//             {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Kavar', click:function(){visualGuide.events.generateVisualGroups('crewMember')}},
//             {type:'button', style:'margin-left:0px;', flexC:'h', color:'bg-voy-yellow-1', label:'S\'Tash', click:function(){visualGuide.events.generateVisualGroups('crewMember')}},
//         ]},

//         // {type:'bar', version:'tiny', color:'bg-voy-grey-1', noEvent:true, flexC:'h'},
        
//         // Bottom Row
//         // {type:'row', flex:'h', style:'margin-bottom:5px; margin-left:65px; margin-right:65px; min-width:0px; width:calc(100% - 130px);', children:[
...
//         //     {type:'button', flexC:'h', label:'Brackets', flexC:'h', style:'max-width:165px;', color:LCARS.colorGen(visualGuide.uiColors), click:function(){visualGuide.events.generateVisualGroups('bracket')}}, 
//         //     {type:'button', flexC:'h', label:'Components', flexC:'h', style:'max-width:165px;', color:LCARS.colorGen(visualGuide.uiColors), click:function(){visualGuide.events.generateVisualGroups('components');}},
//         //     {type:'button', flexC:'h', color:LCARS.colorGen(visualGuide.uiColors), label:'Addons', click:function(){visualGuide.events.generateVisualGroups('addons');}},
//         //     {type:'button', flexC:'h', color:LCARS.colorGen(visualGuide.uiColors), label:'Dialogs', click:function(){visualGuide.events.generateVisualGroups('dialogs')}},
//         //     {type:'button', flexC:'h', click:function(){visualGuide.events.generateVisualGroups('buttons')}, color:LCARS.colorGen(visualGuide.uiColors), label:'Buttons'},
            
//         //     {type:'button', flexC:'h', color:LCARS.colorGen(visualGuide.uiColors), label:'States-colors', click:function(){visualGuide.events.generateVisualGroups('states')}},
//         // ]}       
//     ]},
...
//         {type:'button', label:'Home', flexC:'h', style:'max-width:165px;', color:'bg-voy-yellow-1', click:function(){
//             visualGuide.events.generateVisualGroups('start');
//             // $.each(testArray, function(key, value) {
//             //     $(value).createObject({});
//             // });
//         }}, 
//         {type:'button', label:'Intro', flexC:'h', style:'max-width:165px;', color:'bg-voy-yellow-1', click:function(){
//             visualGuide.events.generateVisualGroups('intro');
//             if ($('#crew-row-1').length) {
//                 $('#crew-row-1').removeObject();
//                 $('#crew-row-2').removeObject();
//             }
//         }}, 
//         {type:'button', label:'Characters', flexC:'h', style:'max-width:165px;', color:'bg-voy-yellow-1', click:function(){
//             if ($('#crew-row-1').length) {
//                 $('#crew-row-1').removeObject();
//                 $('#crew-row-2').removeObject();
//             } else {
...
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Talia Rem', click:function(){visualGuide.events.generateVisualGroups('talia')}},
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1',  label:'Jessica Mayn', click:function(){visualGuide.events.generateVisualGroups('jessica')}},
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Anton Cole', click:function(){visualGuide.events.generateVisualGroups('anton');}},
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Muriel Khoury', click:function(){visualGuide.events.generateVisualGroups('muriel')}},
//                     {type:'button', style:'margin-left:0px;', flexC:'h', color:'bg-voy-yellow-1', label:'Neal Morton', click:function(){visualGuide.events.generateVisualGroups('neal')}},
//                 ]}).createObject({appendTo:'#ui-controls'});
//                 $({type:'row', flex:'h', id:'crew-row-2', style:'margin-bottom:5px; margin-left:65px; margin-right:65px; min-width:0px; width:calc(100% - 130px);', children:[
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Paleth sh\'Tirreq', click:function(){visualGuide.events.generateVisualGroups('paleth')}},
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1',  label:'Kiaro Moretti', click:function(){visualGuide.events.generateVisualGroups('kiaro')}},
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'T\'Vrell', click:function(){visualGuide.events.generateVisualGroups('tvrell');}},
//                     {type:'button', style:'margin-left:0px; margin-right:5px;', flexC:'h', color:'bg-voy-yellow-1', label:'Kavar', click:function(){visualGuide.events.generateVisualGroups('kavar')}},
//                     {type:'button', style:'margin-left:0px;', flexC:'h', color:'bg-voy-yellow-1', label:'S\'Tash', click:function(){visualGuide.events.generateVisualGroups('stash')}},
//                 ]}).createObject({appendTo:'#ui-controls'});
//             }
//         }}, 
//         {type:'bar', flexC:'h', color:'bg-voy-grey-1'}, {type:'cap', version:'right', color:'bg-voy-grey-1'}
//     ]}	
